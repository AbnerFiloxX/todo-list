...
const btnAcciones = e => {
    if (e.tarjet.classList.conttains('fa-check-circle')){
        tareas[e.tarjet-dataset.id].estado = true
        pintarTareas()
    }

    if (e.tarjet.classList.conttains('fa-minus-circle')){
        delete tareas[e.tarjet-dataset.id]
        pintarTareas()
    }

    if (e.tarjet.classList.conttains('fa-undo-alt')){
        tareas[e.tarjet-dataset.id].estado = false
        pintarTareas()
    }
